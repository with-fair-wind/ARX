...
class ZCDB_PORT ZcDbLongTransWorkSetIterator : public ZcRxObject
{
public:
...
class ZCDBCORE2D_PORT ZcDbLongTransaction : public ZcDbObject
{
public:
    ZcDbLongTransaction();
    ~ZcDbLongTransaction();
    ...
    Zcad::ErrorStatus getLongTransactionName(ZcString &) const;
