...
public:
	...
	void           getSamplePoints(double fromParam, double toParam, double approxEps, ZcGePoint3dArray& 
		pointArray, ZcGeDoubleArray& paramArray, bool forceResampling = false) const;
