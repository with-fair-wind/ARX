...
class ZcPlPlotConfigManagerImp;
...
public:
	...
	ZCPL_PORT const ZTCHAR * deviceId() const;
    ZCPL_PORT void setDeviceId(const ZTCHAR * pDevId);
};

class ZCPL_PORT ZSOFT_NO_VTABLE ZcPlPlotConfigManager
{
public:
    ...
    virtual ZcPlPlotConfigManagerImp* impObj();

};

ZCPL_PORT ZcPlPlotConfigManager* ZSOFT_STDCALL zcplPlotConfigManagerPtr();
