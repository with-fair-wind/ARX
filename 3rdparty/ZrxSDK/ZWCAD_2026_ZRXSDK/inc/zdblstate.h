...
class ZCDBCORE2D_PORT ZcDbLayerStateManager: public ZcRxObject
{
public:
...
private:
    ...
    friend class ZcDbImpLayerStateManager;
    ZcDbImpLayerStateManager *mpImpLSM;
};

class ZCDBCORE2D_PORT ZcDbLayerStateManagerReactor : public ZcRxObject
{
public:
    ZCRX_DECLARE_MEMBERS(ZcDbLayerStateManagerReactor);
    ~ZcDbLayerStateManagerReactor();
