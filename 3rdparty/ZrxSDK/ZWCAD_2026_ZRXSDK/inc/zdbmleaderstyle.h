...
class ZCDBCORE2D_PORT ZcDbMLeaderStyle : public ZcDbObject
{
public:
...
public:
	...
	virtual Zcad::ErrorStatus   getName(ZcString & sName) const;	
...
inline Zcad::ErrorStatus ZcDbMLeaderStyle::getName(ZTCHAR*& pName) const
{
    return ::zcutGetZcStringConvertToZTChar(this, &ZcDbMLeaderStyle::getName, pName);
}
