...
class ZCDBCORE2D_PORT ZcDbIdPair
{
public:
    ZcDbIdPair();
...
class ZCDBCORE2D_PORT ZcDbIdMapping: public  ZcRxObject
{
public:
    ZcDbIdMapping();
...
private:
    ...
    ZcDbIdMapping(const ZcDbIdMapping&) = delete;	
    ZcDbIdMapping& operator= (const ZcDbIdMapping&) = delete;	
    ZcDbImpIdMapping* mpImp;
};

class ZCDBCORE2D_PORT ZcDbIdMappingIter: public  ZcRxObject
{
public:
...
private:
	...
	ZcDbIdMappingIter(const ZcDbIdMappingIter&) = delete; 
	ZcDbIdMappingIter& operator= (const ZcDbIdMappingIter&) = delete;
};
