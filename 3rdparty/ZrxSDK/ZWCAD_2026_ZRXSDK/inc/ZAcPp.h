...
#ifndef __IZcPpPaletteSet2_FWD_DEFINED__
#define __IZcPpPaletteSet2_FWD_DEFINED__
typedef interface IZcPpPaletteSet2 IZcPpPaletteSet2;
#endif
...
extern RPC_IF_HANDLE __MIDL_itf_ZcPp_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_ZcPp_0000_0000_v0_0_s_ifspec;
...
#ifndef __IZcPpPaletteSet2_INTERFACE_DEFINED__
#define __IZcPpPaletteSet2_INTERFACE_DEFINED__


	EXTERN_C const IID IID_IZcPpPaletteSet2;

#if defined(__cplusplus) && !defined(CINTERFACE)

	MIDL_INTERFACE("F5EEE553-BE37-4513-8D10-4F2721BAE333")  
		IZcPpPaletteSet2 : public IUnknown
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Anchored(
			VARIANT_BOOL *isAnchored) = 0;
	...
	typedef struct IZcPpPaletteSet2Vtbl
	{
		BEGIN_INTERFACE

			HRESULT(STDMETHODCALLTYPE *QueryInterface)(
				IZcPpPaletteSet2 * This,
				REFIID riid,
				_COM_Outptr_  void **ppvObject);
		...
		HRESULT(STDMETHODCALLTYPE *get_Anchored)(
			IZcPpPaletteSet2 * This,
			VARIANT_BOOL *isAnchored);

		END_INTERFACE
	} IZcPpPaletteSet2Vtbl;

	interface IZcPpPaletteSet2
	{
		CONST_VTBL struct IZcPpPaletteSet2Vtbl *lpVtbl;
	};
...
#define IZcPpPaletteSet2_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IZcPpPaletteSet2_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IZcPpPaletteSet2_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IZcPpPaletteSet2_get_Anchored(This,isAnchored)	\
    ( (This)->lpVtbl -> get_Anchored(This,isAnchored) ) 
