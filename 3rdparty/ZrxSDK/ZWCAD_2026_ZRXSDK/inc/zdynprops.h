...
{
public:
	ZCRX_DECLARE_MEMBERS_EXPIMP(OPMPerInstancePropertySources, ZCDB_PORT);
...
{
public:
	ZCRX_DECLARE_MEMBERS_EXPIMP(OPMPerInstancePropertyExtension, ZCDB_PORT);
...
{
public:
	ZCRX_DECLARE_MEMBERS_EXPIMP(OPMPerInstancePropertyExtensionFactory, ZCDB_PORT);
...
{
public:
	ZCRX_DECLARE_MEMBERS_EXPIMP(OPMPropertyExtension, ZCDB_PORT);
...
{
public:
    ZCRX_DECLARE_MEMBERS_EXPIMP(OPMPropertyExtensionFactory, ZCDB_PORT);
...
IFilterableProperty : public IUnknown
{
    ...
    STDMETHOD(ShowFilterableProperty)(THIS_ DISPID dispID,
                                            ZcFilterablePropertyContext context,
                                            BOOL* pbShow) PURE;
};
