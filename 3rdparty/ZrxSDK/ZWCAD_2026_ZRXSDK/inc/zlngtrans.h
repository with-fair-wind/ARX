...
#define ZC_LONG_TRANSACTION_MANAGER_OBJ ZCRX_T("ZcApLongTransactionManager")

class ZCDB_PORT ZcApLongTransactionReactor: public ZcRxObject 
{ 
public:
    ZCRX_DECLARE_MEMBERS(ZcApLongTransactionReactor);
    virtual ~ZcApLongTransactionReactor() {};
...
class ZCDB_PORT ZcApLongTransactionManager: public ZcRxObject 
{ 
public:
