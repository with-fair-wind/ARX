...
class ZCDBCORE2D_PORT ZcDbIndex : public ZcDbObject
{
public:
...
class ZCDBCORE2D_PORT ZcDbFilteredBlockIterator
{
public:
...
class ZCDBCORE2D_PORT ZcDbCompositeFilteredBlockIterator
{
private:
...
class ZCDBCORE2D_PORT ZcDbIndexUpdateData 
{
    public:
...
class ZCDBCORE2D_PORT ZcDbIndexUpdateDataIterator
{
    public:
...
class ZCDBCORE2D_PORT ZcDbBlockChangeIterator
{
private:
