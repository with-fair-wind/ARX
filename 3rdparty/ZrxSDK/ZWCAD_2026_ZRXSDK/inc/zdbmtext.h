...
public:
    ...
    void getBoundingPointsByLine(ZcArray<ZcGePoint3dArray>&) const;
...
inline ZTCHAR * ZcDbMText::contents() const
{
    return ::zcutGetZcStringConvertToZTChar(this, &ZcDbMText::contents);
}

inline ZTCHAR * ZcDbMText::contentsRTF() const
{
    return ::zcutGetZcStringConvertToZTChar(this, &ZcDbMText::contentsRTF);
}

inline ZTCHAR * ZcDbMText::text() const
{
    return ::zcutGetZcStringConvertToZTChar(this, &ZcDbMText::text);
}
