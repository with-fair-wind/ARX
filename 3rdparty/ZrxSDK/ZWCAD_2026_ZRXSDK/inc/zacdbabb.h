...
#ifndef ZD_ZACDBABB_H
#define ZD_ZACDBABB_H 1
...
const ZcDb::UnitsValue kUnitsUSSurveyFeet   = ZcDb::kUnitsUSSurveyFeet;
const ZcDb::UnitsValue kUnitsUSSurveyInch   = ZcDb::kUnitsUSSurveyInch;
const ZcDb::UnitsValue kUnitsUSSurveyYard   = ZcDb::kUnitsUSSurveyYard;
const ZcDb::UnitsValue kUnitsUSSurveyMile   = ZcDb::kUnitsUSSurveyMile;
