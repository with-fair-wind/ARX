...
class ZCDBCORE2D_PORT ZcDbHatch: public ZcDbEntity
{
public:
	...
	const ZTCHAR (&patternName()const)[HATCH_PATTERN_NAME_LENGTH];	
	...
	Zcad::ErrorStatus  evaluateHatchAllScales(bool bUnderestimateNumLines = false);	
    ...
    virtual Zcad::ErrorStatus subSwapIdWith(ZcDbObjectId otherId,
				 ...
				 ZSoft::Boolean swapExtDict = false) override;
