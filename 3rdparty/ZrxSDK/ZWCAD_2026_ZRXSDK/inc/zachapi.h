...
{
    ZSOFT_UNREFED_PARAM(lFlags);
}

class ZCDBCORE2D_PORT ZcDbHyperlinkCollection
{
public:
    ...
    virtual void addAt(const int nIndex, const ZTCHAR * sName,
                       ...
                       const ZTCHAR * sSubLocation = NULL) = 0;
    void addAt(int index, const ZcDbHyperlink* pHLink);
...
class ZCDBCORE2D_PORT ZcDbEntityHyperlinkPE : public ZcRxObject
{
public:
