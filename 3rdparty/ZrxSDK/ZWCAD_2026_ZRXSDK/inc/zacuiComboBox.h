...
virtual void    GetContentExtent (LPCTSTR text, int& width, int& height) override;
    virtual BOOL    GetItemColors(DRAWITEMSTRUCT& dis, COLORREF& fgColor,
        COLORREF& bgColor, COLORREF& fillColor);

protected:
virtual BOOL    OnGetTipRect (CRect& r) override;
...
public:
	...
	virtual void    OnComboBoxInit () override;
...
protected:
	virtual void DrawItemImage (CDC& dc, CRect& r, INT_PTR cargo) override;
	virtual void OnAddItems () override;
	virtual BOOL OnSelectOther (BOOL isOther2, int curSel, int& newSel) override;
    INT_PTR  GetItemCargo (int item);
	...
	virtual int ImageWidth() override;
...
virtual BOOL    GetOtherName (BOOL isOther2, CString& name) override;
...
protected:
virtual void    DrawItemImage (CDC& dc, CRect& r, INT_PTR cargo) override;
virtual int     CalcItemHeight () override;
virtual BOOL    GetOtherName (BOOL isOther2, CString& name) override;
virtual void    OnAddItems () override;
virtual void    OnComboBoxInit ();   
...
private:
    CBitmap* m_pArrowBitmapImage; 
    CZdUiImage* m_pArrowImage;    
    int     m_arrowCount;
    int     m_arrowSize;
    BOOL    m_bUseOrigin2;
