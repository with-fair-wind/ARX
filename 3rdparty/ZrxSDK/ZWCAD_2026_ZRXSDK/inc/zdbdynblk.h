...
class ZCDBCORE2D_PORT ZcDbDynBlockReferenceProperty : public ZcHeapOperators
{
public:
    enum UnitsType {
        kNoUnits = 0,
...
class ZCDBCORE2D_PORT ZcDbDynBlockReference : public ZcHeapOperators
{
public:
...
class ZCDBCORE2D_PORT ZcDbDynBlockTableRecord : public ZcHeapOperators
{
public:
