...
public:
    ...
    STDMETHOD (get_Color)(VARIANT *pVar)
    {
        ...
        pIZcadZcCmColor->put_EntityColor(m_Color.getRGBM());
    ...
    ZcTcTool *CreateCommandToolATC(ZcTcPackage *pPalette,LPWSTR szToolName,LPCWSTR szBitmapName, LPWSTR macroString)
    {
		...
		try
		{
			...
			const GUID GenericStockToolId = {0xEC922FCE,0x5A21,0x11E7,{0xB7,0x2E,0xBC,0x5F,0xF4,0x2A,0xC8,0x39}};
