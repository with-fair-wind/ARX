...
class ZCDBCORE2D_PORT ZcGiLightTraits : public ZcGiNonEntityTraits
{
public:
...
class ZCDBCORE2D_PORT ZcGiShadowParameters : public ZcRxObject
{
public:
...
class  ZCDBCORE2D_PORT ZcGiLightAttenuation : public ZcRxObject
{
public:
...
class ZCDBCORE2D_PORT ZcGiSkyParameters : public ZcRxObject
{
public:
...
class ZCDBCORE2D_PORT ZcGiStandardLightTraits : public ZcGiLightTraits
{
public:
...
class ZCDBCORE2D_PORT ZcGiPointLightTraits : public ZcGiStandardLightTraits
{
public:
...
class ZCDBCORE2D_PORT ZcGiSpotLightTraits : public ZcGiStandardLightTraits
{
public:
...
class ZCDBCORE2D_PORT ZcGiDistantLightTraits : public ZcGiStandardLightTraits
{
public:
...
class ZCDBCORE2D_PORT ZcGiWebLightTraits : public ZcGiPointLightTraits
{
public:
