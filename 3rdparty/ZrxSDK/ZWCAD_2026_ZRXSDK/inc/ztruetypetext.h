...
typedef void (*LineSegmentCallback) (const ZcGePoint3d &, const ZcGePoint3d &, const void *);
...
class Scores {
  private:
    ...
    ZcGePoint3d         m_over_point[2];
    ZcGePoint3d         m_under_point[2];
    ZcGePoint3d         m_strikethrough_point[2];
    ZcGePoint3d         m_bbox[4];
    TextParams const *  m_pTextParams;
    LineSegmentCallback m_pLineSegmentCB;
    void *              m_pAction;
    ZcGiContext *       m_pContext;

#define ON          1
#define OFF         0

  public:
    Scores(ZcGiContext * pContext, TextParams const * pTextParams, LineSegmentCallback pLineSegment, void * pAction);
    ~Scores () {};
    ...
    void draw_vector (ZcGePoint3d const & p1, ZcGePoint3d const & p2);
};
