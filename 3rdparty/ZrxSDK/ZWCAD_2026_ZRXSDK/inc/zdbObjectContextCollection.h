...
class ZCDBCORE2D_PORT ZSOFT_NO_VTABLE ZcDbObjectContextCollection: public ZcRxObject
{
public:
...
class ZCDBCORE2D_PORT ZSOFT_NO_VTABLE ZcDbObjectContextCollectionIterator : public ZcRxObject
{
public:
