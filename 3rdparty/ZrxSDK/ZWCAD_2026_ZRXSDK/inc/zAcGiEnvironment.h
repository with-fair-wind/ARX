...
class ZCDBCORE2D_PORT ZcGiSolidBackgroundTraits : public ZcGiNonEntityTraits
{
public:
...
class ZCDBCORE2D_PORT ZcGiGradientBackgroundTraits : public ZcGiNonEntityTraits
{
public:
...
class ZCDBCORE2D_PORT ZcGiImageBackgroundTraits : public ZcGiNonEntityTraits
{
public:
...
class ZCDBCORE2D_PORT ZcGiGroundPlaneBackgroundTraits : public ZcGiNonEntityTraits
{
public:
...
class ZCDBCORE2D_PORT ZcGiSkyBackgroundTraits : public ZcGiNonEntityTraits
{
public:
...
class ZCDBCORE2D_PORT ZcGiIBLBackgroundTraits : public ZcGiNonEntityTraits
{
public:
    ZCRX_DECLARE_MEMBERS(ZcGiIBLBackgroundTraits);

    virtual void            setEnable               (const bool bEnable)    = 0;
    virtual bool            enable                  (void) const            = 0;
    virtual void            setIBLImageName         (const ZcString& name)  = 0;
    virtual ZcString        IBLImageName            (void) const            = 0;
    ...
    virtual void            setSecondaryBackground  (const ZcDbObjectId bg) = 0;
    virtual ZcDbObjectId    secondaryBackground     (void) const            = 0;
};

class ZcGiMaterialTexture;

class ZCDBCORE2D_PORT ZcGiRenderEnvironmentTraits : public ZcGiNonEntityTraits
{
public:
...
class ZCDBCORE2D_PORT ZcGiRenderSettingsTraits : public ZcGiNonEntityTraits  
{
public:
...
class ZCDBCORE2D_PORT ZcGiMentalRayRenderSettingsTraits : public ZcGiRenderSettingsTraits
{
public:
...
class ZCDBCORE2D_PORT ZcGiRapidRTRenderSettingsTraits : public ZcGiNonEntityTraits
{
public:
    ZCRX_DECLARE_MEMBERS(ZcGiRapidRTRenderSettingsTraits);

    virtual void setQuitCondition(ZcGiQuitCondition quitCondition) = 0;
    virtual ZcGiQuitCondition quitCondition() const = 0;
    ...
    virtual void setLightingMode(ZcGiLightingMode mode) = 0;
    virtual ZcGiLightingMode lightingMode() const = 0;
    virtual void setFilterType(ZcGiFilterType filterInfo) = 0;
    virtual ZcGiFilterType filterType() const = 0;
...
class ZCDBCORE2D_PORT ZcGiToneOperatorParameters : public ZcRxObject
{
public:
...
class ZCDBCORE2D_PORT ZcGiPhotographicExposureParameters : public ZcGiToneOperatorParameters
{
public:
    ZCRX_DECLARE_MEMBERS(ZcGiPhotographicExposureParameters);

    ZcGiPhotographicExposureParameters();
    virtual ~ZcGiPhotographicExposureParameters();

    ZcGiPhotographicExposureParameters& operator=(const ZcGiPhotographicExposureParameters& params);
    bool operator==(const ZcGiPhotographicExposureParameters& params) const;
