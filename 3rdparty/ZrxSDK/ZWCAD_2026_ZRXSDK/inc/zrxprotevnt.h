...
class ZCBASE_PORT ZSOFT_NO_VTABLE ZcRxProtocolReactor : public ZcRxObject
{
public:
    ZCRX_DECLARE_MEMBERS(ZcRxProtocolReactor);
};

class ZCBASE_PORT ZSOFT_NO_VTABLE ZcRxProtocolReactorIterator : public ZcRxObject
{
public:
...
class ZCBASE_PORT ZSOFT_NO_VTABLE ZcRxProtocolReactorList : public ZcRxObject
{
public:
...
class ZCBASE_PORT ZSOFT_NO_VTABLE ZcRxProtocolReactorListIterator : public ZcRxObject
{
public:
...
class ZCBASE_PORT ZSOFT_NO_VTABLE ZcRxProtocolReactorManager: public ZcRxObject
{
public:
...
class ZCBASE_PORT ZSOFT_NO_VTABLE ZcRxProtocolReactorManagerFactory : public ZcRxService
{
public:
