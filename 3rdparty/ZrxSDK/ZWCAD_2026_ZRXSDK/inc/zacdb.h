...
#define ZCDB_MODEL_SPACE               ZCRX_T("*Model_Space")
#define ZCDB_PAPER_SPACE               ZCRX_T("*Paper_Space")
#define ZCDB_NULL_HANDLE               ZCRX_T("\0\0\0\0\0\0\0")
#define ZCDB_OPEN_BRACE_STR            ZCRX_T("{")
#define ZCDB_OPEN_BRACE_CHAR           ZCRX_T('{')
#define ZCDB_CLOSE_BRACE_STR           ZCRX_T("}")
#define ZCDB_CLOSE_BRACE_CHAR          ZCRX_T('}')
#define ZCDB_GROUP_DICTIONARY          ZCRX_T("ACAD_GROUP")
#define ZCDB_MLINESTYLE_DICTIONARY     ZCRX_T("ACAD_MLINESTYLE")
#define ZCDB_LAYOUT_DICTIONARY         ZCRX_T("ACAD_LAYOUT")
#define ZCDB_PLOTSETTINGS_DICTIONARY   ZCRX_T("ACAD_PLOTSETTINGS")
#define ZCDB_PLOTSTYLENAME_DICTIONARY  ZCRX_T("ACAD_PLOTSTYLENAME")
#define ZCDB_MATERIAL_DICTIONARY       ZCRX_T("ACAD_MATERIAL")
#define ZCDB_VISUALSTYLE_DICTIONARY    ZCRX_T("ACAD_VISUALSTYLE")
#define ZCDB_COLOR_DICTIONARY          ZCRX_T("ACAD_COLOR")
#define ZCDB_TABLESTYLE_DICTIONARY     ZCRX_T("ACAD_TABLESTYLE")
#define ZCDB_EMBEDDED_OBJECT_STR       ZCRX_T("Embedded Object")
#define ZCDB_LAYERSTATES_DICTIONARY    ZCRX_T("ACAD_LAYERSTATES")
#define ZCDB_FIELD_DICTIONARY          ZCRX_T("ACAD_FIELD")
#define ZCDB_FIELDLIST                 ZCRX_T("ACAD_FIELDLIST")

#define ZCDB_ENHANCED_BLOCK            ZCRX_T("ACAD_ENHANCEDBLOCK")
#define ZCDB_ENHANCED_BLOCK_EVALKEY    ZCRX_T("ACAD_ENHANCEDBLOCKEVALKEY")
#define ZCDB_ENHANCED_BLOCK_REF        ZCRX_T("ACAD_ENHANCEDBLOCK_REFERENCE")
#define ZCDB_SECTION_MANAGER           ZCRX_T("ACAD_SECTION_MANAGER")
#define ZCDB_DATALINK                  ZCRX_T("ACAD_DATALINK")
#define ZCDB_MLEADERSTYLE_DICTIONARY   ZCRX_T("ACAD_MLEADERSTYLE")

#define ZCDB_ASSOCNETWORK_DICTIONARY   ZCRX_T("ACAD_ASSOCNETWORK")
#define ZCDB_SECTIONSTYLE_DICTIONARY   ZCRX_T("ACAD_SECTIONVIEWSTYLE")
#define ZCDB_DETAILSTYLE_DICTIONARY    ZCRX_T("ACAD_DETAILVIEWSTYLE")

#define ZCDB_ANNOTATIONSCALES_COLLECTION zcdbAnnotationScaleCollectionName()
...
struct ZcDb
{
    ...
    typedef ZSoft::UInt32    SubentType;
    ...
    enum ZcDbDwgVersion    { kDHL_MC0_0   = 0,
                             kDHL_AC1_2   = 1,
                             kDHL_AC1_40  = 2,
                             kDHL_AC1_50  = 3,
                             kDHL_AC2_20  = 4,
