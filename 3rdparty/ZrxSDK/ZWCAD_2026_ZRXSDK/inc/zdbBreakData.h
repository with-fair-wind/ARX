...
class ZCDB_PORT ZcDbBreakData : public ZcDbObject
{
public:
    ...
    virtual void  modifiedGraphics(const ZcDbEntity* pEnt) override;
    Zcad::ErrorStatus updateAssociativity(const ZcDbObjectIdArray& ids, int cmdType);
};

class ZCDB_PORT ZcDbBreakPointRef : public ZcDbObject
{
public:
