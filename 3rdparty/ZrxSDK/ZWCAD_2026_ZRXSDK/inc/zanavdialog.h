...
protected:
    ...
    virtual ZDUI_REPLY OnNotifyControlChange(UINT controlId, LPARAM lParam) override;
    virtual ZDUI_REPLY OnNotifyGeneric(UINT controlId, LPARAM lParam) override;
