...
#include "zAcPlPrecisionEntry.h"
#include "zacarray.h"
#include "zAcString.h"

typedef ZcArray<ZcPlDSDEntry, ZcArrayObjectCopyReallocator <ZcPlDSDEntry> > ZcPlDSDEntries;
typedef ZcArray<ZcPlPrecisionEntry, ZcArrayObjectCopyReallocator <ZcPlPrecisionEntry> > ZcPlPrecisionEntries;
...
public:
    ...
    ZCPL_PORT void              getPrecisionEntries(ZcPlPrecisionEntries &val) const;
    ZCPL_PORT void              setPrecisionEntries(const ZcPlPrecisionEntries &val);
    ...
    ZCPL_PORT void              setUnrecognizedData(
									const ZcStringArray& sectionArray,
									const ZcStringArray& dataArray);
    ZCPL_PORT void              getUnrecognizedData(
									ZcStringArray& sectionArray,
									ZcStringArray& dataArray) const;
    ...
    ZCPL_PORT bool              viewFile() const;
    ZCPL_PORT void              setViewFile(bool bViewFile);
    ...
    ZCPL_PORT bool              lineMerge() const;
    ZCPL_PORT void              setLineMerge(bool bOn);
    ZCPL_PORT const ZTCHAR *    currentPrecision() const;
    ZCPL_PORT void              setCurrentPrecision(const ZTCHAR * pCurrentPrecision);
    ...
    ZCPL_PORT bool              initializeLayouts() const;
    ZCPL_PORT void              setInitializeLayouts(bool initLayouts);
};
