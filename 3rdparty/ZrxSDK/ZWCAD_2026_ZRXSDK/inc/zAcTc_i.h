...
#ifndef __IZcadToolProperties3_FWD_DEFINED__
#define __IZcadToolProperties3_FWD_DEFINED__
typedef interface IZcadToolProperties3 IZcadToolProperties3;
...
EXTERN_C const IID IID_IZcadToolProperties;
    ...
    MIDL_INTERFACE("EC923006-5A21-11E7-B72E-BC5FF42AC839")
...
EXTERN_C const IID IID_IZcadToolProperties2;
    ...
    MIDL_INTERFACE("EC92303E-5A21-11E7-B72E-BC5FF42AC839")
...
#ifndef __IZcadToolProperties3_INTERFACE_DEFINED__
#define __IZcadToolProperties3_INTERFACE_DEFINED__


	EXTERN_C const IID IID_IZcadToolProperties3;

#if defined(__cplusplus) && !defined(CINTERFACE)

	MIDL_INTERFACE("EC9232BB-5A21-11E7-B72E-BC5FF42AC839")
		IZcadToolProperties3 : public IDispatch
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE GetDarkImage(
			long cx,
			long cy,
			IUnknown **pVal,
			BSTR *sResourceName,
		...
		virtual HRESULT STDMETHODCALLTYPE SetDarkImage(
			long cx,
			long cy,
			IUnknown *newVal,
			BSTR sResourceName,
		...
		virtual HRESULT STDMETHODCALLTYPE GetDarkOverlayImage(
			IUnknown **pVal,
			BSTR *pResourceName,
			BSTR *pSourceFile) = 0;

		virtual HRESULT STDMETHODCALLTYPE SetDarkOverlayImage(
			IUnknown *newVal,
			BSTR sResourceName,
			BSTR sSourceFile) = 0;
	...
	typedef struct IZcadToolProperties3Vtbl
	{
		BEGIN_INTERFACE

			HRESULT(STDMETHODCALLTYPE *QueryInterface)(
				IZcadToolProperties3 * This,
				REFIID riid,
				_COM_Outptr_  void **ppvObject);
		...
		HRESULT(STDMETHODCALLTYPE *GetDarkImage)(
			IZcadToolProperties3 * This,
			long cx,
			long cy,
			IUnknown **pVal,
		...
		HRESULT(STDMETHODCALLTYPE *SetDarkImage)(
			IZcadToolProperties3 * This,
			long cx,
			long cy,
			IUnknown *newVal,
		...
		HRESULT(STDMETHODCALLTYPE *GetDarkOverlayImage)(
			IZcadToolProperties3 * This,
			IUnknown **pVal,
			BSTR *pResourceName,
			BSTR *pSourceFile);

		HRESULT(STDMETHODCALLTYPE *SetDarkOverlayImage)(
			IZcadToolProperties3 * This,
			IUnknown *newVal,
			BSTR sResourceName,
			BSTR sSourceFile);
		...
		END_INTERFACE
	} IZcadToolProperties3Vtbl;

	interface IZcadToolProperties3
	{
		CONST_VTBL struct IZcadToolProperties3Vtbl *lpVtbl;
	};
...
#define IZcadToolProperties3_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IZcadToolProperties3_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IZcadToolProperties3_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IZcadToolProperties3_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define IZcadToolProperties3_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define IZcadToolProperties3_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define IZcadToolProperties3_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 


#define IZcadToolProperties3_GetDarkImage(This,cx,cy,pVal,sResourceName,sSourceFile)	\
    ( (This)->lpVtbl -> GetDarkImage(This,cx,cy,pVal,sResourceName,sSourceFile) ) 

#define IZcadToolProperties3_SetDarkImage(This,cx,cy,newVal,sResourceName,sSourceFile)	\
    ( (This)->lpVtbl -> SetDarkImage(This,cx,cy,newVal,sResourceName,sSourceFile) ) 

#define IZcadToolProperties3_GetDarkOverlayImage(This,pVal,pResourceName,pSourceFile)	\
    ( (This)->lpVtbl -> GetDarkOverlayImage(This,pVal,pResourceName,pSourceFile) ) 

#define IZcadToolProperties3_SetDarkOverlayImage(This,newVal,sResourceName,sSourceFile)	\
    ( (This)->lpVtbl -> SetDarkOverlayImage(This,newVal,sResourceName,sSourceFile) ) 
...
EXTERN_C const IID IID_IZcadStockTool;
    ...
    MIDL_INTERFACE("EC9230FD-5A21-11E7-B72E-BC5FF42AC839")
...
EXTERN_C const IID IID_IZcadToolContextMenu;
    ...
    MIDL_INTERFACE("EC923113-5A21-11E7-B72E-BC5FF42AC839")
...
EXTERN_C const IID IID_IZcadTool;
    ...
    MIDL_INTERFACE("EC9231AF-5A21-11E7-B72E-BC5FF42AC839")
...
EXTERN_C const IID IID_IZcadTool2;
    ...
    MIDL_INTERFACE("EC9230CD-5A21-11E7-B72E-BC5FF42AC839")
...
EXTERN_C const IID IID_IZcadToolFlyoutShape;
    ...
    MIDL_INTERFACE("EC9230B2-5A21-11E7-B72E-BC5FF42AC839")
...
EXTERN_C const IID IID_IZcadToolSort;
    ...
    MIDL_INTERFACE("EC92318B-5A21-11E7-B72E-BC5FF42AC839")
...
EXTERN_C const IID IID_IZcadToolDropTarget;
    ...
    MIDL_INTERFACE("EC9231AA-5A21-11E7-B72E-BC5FF42AC839")
...
EXTERN_C const IID IID_IZcadToolDragSource;
    ...
    MIDL_INTERFACE("EC923052-5A21-11E7-B72E-BC5FF42AC839")
...
EXTERN_C const IID IID_IZcadToolCopyPaste;
    ...
    MIDL_INTERFACE("EC923129-5A21-11E7-B72E-BC5FF42AC839")
...
EXTERN_C const IID IID_IZcadToolImage;
    ...
    MIDL_INTERFACE("EC922FE9-5A21-11E7-B72E-BC5FF42AC839")
...
class DECLSPEC_UUID("EC923066-5A21-11E7-B72E-BC5FF42AC839")
ZcadToolProperties;
#endif
...
class DECLSPEC_UUID("EC922FD4-5A21-11E7-B72E-BC5FF42AC839")
ZcadToolImage;
#endif
#endif 
