...
public:
	...
	ZcGeNurbCurve2d (const ZcGePoint2dArray& fitPoints, 
		...
		ZSoft::Boolean endTangentDefined,
    ...
    ZcGeNurbCurve2d(const ZcGeCurve2d& curve, 
    ...
    ZSoft::Boolean  getFitKnotParameterization(KnotParameterization& knotParam) const;
    ...
    ZSoft::Boolean   setFitTangents   (const ZcGeVector2d& startTangent, 
	                        	       const ZcGeVector2d& endTangent);
    ZSoft::Boolean   setFitKnotParameterization(KnotParameterization knotParam);
    ...
    ZSoft::Boolean    buildFitData    ();
    ZSoft::Boolean    buildFitData    (KnotParameterization kp);
    ...
    ZSoft::Boolean    addControlPointAt(double newKnot, const ZcGePoint2d& point, double weight = 1.0);
    ZSoft::Boolean    deleteControlPointAt(int index);
