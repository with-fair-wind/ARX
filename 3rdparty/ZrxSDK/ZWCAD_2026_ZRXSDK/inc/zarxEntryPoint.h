...
#ifndef _ZSOFT_MAC_
#define ZRXCOMMAND_FIRST_ENTRYNAME "ZRXCOMMAND$__a"
#else
#define ZRXCOMMAND_FIRST_ENTRYNAME "ZRXCOMMAND$__m"
#endif
#define ZRXCOMMAND_LAST_ENTRYNAME "ZRXCOMMAND$__z"

extern "C" {
	__declspec(selectany) __declspec(allocate(ZRXCOMMAND_FIRST_ENTRYNAME)) _ZRXCOMMAND_ENTRY* __pZrxCmdMapEntryFirst =NULL ;
	__declspec(selectany) __declspec(allocate(ZRXCOMMAND_LAST_ENTRYNAME)) _ZRXCOMMAND_ENTRY* __pZrxCmdMapEntryLast =NULL ;
}
...
#endif
#else
#define ZCED_ZRXCOMMAND_ENTRY_PRAGMA(group,globCmd)
#endif

#define ZCED_ZRXCOMMAND_ENTRY_AUTO(classname, group, globCmd, locCmd, cmdFlags, UIContext) \
    __declspec(selectany) _ZRXCOMMAND_ENTRY __ZrxCmdMap_##group##globCmd = { _RXST(#group), _RXST(#globCmd), _RXST(#locCmd), cmdFlags, classname::group ##globCmd, UIContext, 0 } ; \
    extern "C" __declspec(allocate("ZRXCOMMAND$__m")) __declspec(selectany) _ZRXCOMMAND_ENTRY* __pZrxCmdMap_##group##globCmd = &__ZrxCmdMap_##group##globCmd ; \
...
#ifndef _ZSOFT_MAC_
#define ZDSSYMBOL_FIRST_ENTRYNAME "ZDSSYMBOL$__a"
#else
#define ZDSSYMBOL_FIRST_ENTRYNAME "ZDSSYMBOL$__m"
#endif
#define ZDSSYMBOL_LAST_ENTRYNAME "ZDSSYMBOL$__z"


extern "C" {
    __declspec(selectany) __declspec(allocate(ZDSSYMBOL_FIRST_ENTRYNAME)) _ZDSSYMBOL_ENTRY* __pZdsSymbolMapEntryFirst =NULL ;
    __declspec(selectany) __declspec(allocate(ZDSSYMBOL_LAST_ENTRYNAME)) _ZDSSYMBOL_ENTRY* __pZdsSymbolMapEntryLast =NULL ;
}
...
#endif
#else
#define ZCED_ADSSYMBOL_ENTRY_PRAGMA(name)
#endif
...
#define ZCED_ZDSSYMBOL_ENTRY_AUTO(classname, name, regFunc) \
    ...
    extern "C" __declspec(allocate("ZDSSYMBOL$__m")) __declspec(selectany) _ZDSSYMBOL_ENTRY*  __pZdsSymbolMap_##name = &__ZdsSymbolMap_##name ; \
...
#define ZCED_ZDSSYMBOL_ENTRYBYID_AUTO(classname, name, nameId, regFunc) \
    ...
    extern "C" __declspec(allocate("ADSSYMBOL$__m")) __declspec(selectany) _ZDSSYMBOL_ENTRY*  __pZdsSymbolMap_##name = &__ZdsSymbolMap_##name ; \
    ZCED_ZDSSYMBOL_ENTRY_PRAGMA(name)
