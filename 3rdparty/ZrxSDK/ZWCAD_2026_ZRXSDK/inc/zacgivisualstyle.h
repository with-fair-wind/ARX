...
class ZCDBCORE2D_PORT ZcGiVisualStyle : public ZcRxObject
{
public:
    ...
    virtual bool      setTrait    (ZcGiVisualStyleProperties::Property prop,
											const ZcString *pStr,
                                             ZcGiVisualStyleOperations::Operation op
                                             = ZcGiVisualStyleOperations::kSet);

    virtual const ZcGiVariant& trait (Property prop, 
    ...
    static ZcGiVariant::VariantType propertyType(Property prop);
...
class ZCDBCORE2D_PORT ZcGiVisualStyleTraits : public ZcGiDrawableTraits
{
public:
...
class ZCDBCORE2D_PORT ZcGiFaceStyle : public ZcRxObject
{
public:
...
class ZCDBCORE2D_PORT ZcGiEdgeStyle : public ZcRxObject
{
public:
...
class ZCDBCORE2D_PORT ZcGiDisplayStyle : public ZcRxObject
{
public:
