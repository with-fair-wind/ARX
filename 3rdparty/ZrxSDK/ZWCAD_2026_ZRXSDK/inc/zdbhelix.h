...
class ZCDBCORE2D_PORT ZcDbHelix : public ZcDbSpline
{
public:
	enum ConstrainType {
		kTurnHeight = 0,
...
public:
	GEOMENT_DECLARE_MEMBERS(ZcDbHelix);
	...
	Zcad::ErrorStatus reverseCurve() override;
protected:
	Zcad::ErrorStatus  subGetClassID(CLSID* pClsid) const override;
};
#pragma pack (pop)
