...
class ZCDBCORE2D_PORT ZSOFT_NO_VTABLE ZcDbProxyObject : public ZcDbObject
{
public:
    ...
    virtual ZcDb::DuplicateRecordCloning mergeStyle() const override = 0;
...
class ZCDBCORE2D_PORT ZSOFT_NO_VTABLE ZcDbProxyEntity : public ZcDbEntity
{
public:
