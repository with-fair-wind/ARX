...
class ZCDBCORE2D_PORT ZcDbDataCell : public ZcRxObject
{
public:
    enum CellType {
        kUnknown = 0,
	...
	virtual ZcDbDataCell& operator = (const ZcString & s);		
	...
	virtual operator ZcString & () const;	
...
class ZCDBCORE2D_PORT ZcDbDataColumn : public ZcRxObject
{
public:
    ZcDbDataColumn();
...
class ZCDBCORE2D_PORT ZcDbDataTable : public ZcDbObject
{
public:
	...
	virtual Zcad::ErrorStatus getColumnNameAt(ZSoft::UInt32 index, ZcString & sName) const;

    virtual Zcad::ErrorStatus getColumnNameAt(ZSoft::UInt32 index,
        ZTCHAR *& pName) const final;
...
inline Zcad::ErrorStatus ZcDbDataTable::getColumnNameAt(ZSoft::UInt32 index,
    ZTCHAR *& pName) const
{
    ZcString sName;
    return zcutZcStringToZTChar(sName, pName, this->getColumnNameAt(index, sName));
}
