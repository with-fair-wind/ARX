...
class ZCDBCORE2D_PORT ZcDbGraphNode : public ZcHeapOperators
{
...
class ZCDBCORE2D_PORT ZcDbGraph : public ZcHeapOperators
{
...
class ZCDBCORE2D_PORT ZcDbGraphStack : public ZcHeapOperators
{
public:
