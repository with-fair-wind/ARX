...
class ZCDBCORE2D_PORT ZcDbGripData {
public:
    ZcDbGripData();
	ZcDbGripData(const ZcGePoint3d&, void* AppData);
    ZSOFT_DEPRECATE_FOR_INTERNAL_USE ZcDbGripData(const ZcGePoint3d&, void*, GripOperationPtr hotGrip,
	...
	ZSOFT_DEPRECATE_FOR_INTERNAL_USE ZcDbGripData(const ZcGePoint3d&, void*, ZcRxClass*,
...
inline ZcDbGripData::ZcDbGripData()
	: m_pAppData(NULL), 
