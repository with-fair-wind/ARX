...
HRESULT ZXAUTOEXP
	ZcAxGet_UIsolineDensity(ZcDbObjectId& objId, long* density);

HRESULT ZXAUTOEXP
	ZcAxPut_UIsolineDensity(ZcDbObjectId& objId, long density);

HRESULT ZXAUTOEXP
	ZcAxGet_VIsolineDensity(ZcDbObjectId& objId, long* density);

HRESULT ZXAUTOEXP
	ZcAxPut_VIsolineDensity(ZcDbObjectId& objId, long density);

HRESULT ZXAUTOEXP
	ZcAxGet_WireframeType(ZcDbObjectId& objId, ZcWireframeType *type);

HRESULT ZXAUTOEXP
	ZcAxPut_WireframeType(ZcDbObjectId& objId, ZcWireframeType type);

HRESULT ZXAUTOEXP
	ZcAxGetMaintainAssociativity(ZcDbObjectId& objId, int *maintainAssoc);

HRESULT ZXAUTOEXP
	ZcAxPutMaintainAssociativity(ZcDbObjectId& objId, int maintainAssoc);

HRESULT ZXAUTOEXP
	ZcAxGetShowAssociativity(ZcDbObjectId& objId, VARIANT_BOOL* bEnabled);

HRESULT ZXAUTOEXP
	ZcAxPutShowAssociativity(ZcDbObjectId& objId, VARIANT_BOOL bEnabled);

HRESULT ZXAUTOEXP
	ZcAxGetEdgeExtensionDistances(ZcDbObjectId& objId, VARIANT *extDistances);

HRESULT ZXAUTOEXP
	ZcAxPutEdgeExtensionDistances(ZcDbObjectId& objId, VARIANT extDistances);

HRESULT ZXAUTOEXP
	ZcAxGetSurfTrimAssociativity(ZcDbObjectId& objId, VARIANT *associative);

HRESULT ZXAUTOEXP
	ZcAxPutSurfTrimAssociativity(ZcDbObjectId& objId, VARIANT associative);
...
interface IZcadBaseObject : public IUnknown
{
	STDMETHOD(QueryInterface)(THIS_ REFIID riid, LPVOID FAR* ppvObj) PURE;
	STDMETHOD_(ULONG, AddRef)(THIS) PURE;
	STDMETHOD_(ULONG, Release)(THIS) PURE;
...
interface IZcadBaseObject2 : public IUnknown       
{
	STDMETHOD(QueryInterface)(THIS_ REFIID riid, LPVOID FAR* ppvObj) PURE;
	STDMETHOD_(ULONG, AddRef)(THIS) PURE;
	STDMETHOD_(ULONG, Release)(THIS) PURE;
...
interface IZcadBaseDatabase : public IUnknown
{
	STDMETHOD(QueryInterface)(THIS_ REFIID riid, LPVOID FAR* ppvObj) PURE;
	STDMETHOD_(ULONG, AddRef)(THIS) PURE;
	STDMETHOD_(ULONG, Release)(THIS) PURE;
