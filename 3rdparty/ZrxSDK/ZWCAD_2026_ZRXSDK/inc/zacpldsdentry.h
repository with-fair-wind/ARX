...
public:
    ...
    ZCPL_PORT ZcPlDSDEntry::SetupType setupType() const;
    ZCPL_PORT void              setSetupType(ZcPlDSDEntry::SetupType eType);

    ZCPL_PORT const ZTCHAR*      orgSheetPath() const;

    ZCPL_PORT const ZTCHAR*      traceSession() const;
    ZCPL_PORT void              setTraceSession(const ZTCHAR* pTraceSession);
};
