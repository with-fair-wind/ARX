...
class ZCGIMAT_IMPEXP ZcGiMaterialTraits : public ZcGiNonEntityTraits
{
public:
...
class ZCGIMAT_IMPEXP ZcGiMaterialColor: public ZcRxObject
{
public:
    ...
    static const ZcGiMaterialColor kNull;
...
class ZCGIMAT_IMPEXP ZcGiMaterialTexture : public ZcRxObject
{
public:
...
class ZCGIMAT_IMPEXP ZcGiImageTexture : public ZcGiMaterialTexture
{
public:
...
class ZCGIMAT_IMPEXP ZcGiImageFileTexture : public ZcGiImageTexture
{
...
public:
	...
	virtual bool operator==(const ZcGiMaterialTexture & texture) const override;
...
class ZCGIMAT_IMPEXP ZcGiProceduralTexture : public ZcGiMaterialTexture
{
public:
...
class ZCGIMAT_IMPEXP ZcGiGenericTexture : public ZcGiProceduralTexture
{
public:
...
class ZCGIMAT_IMPEXP ZcGiWoodTexture : public ZcGiProceduralTexture
{
...
class ZCGIMAT_IMPEXP ZcGiMarbleTexture : public ZcGiProceduralTexture
{
...
class ZCGIMAT_IMPEXP ZcGiMaterialMap: public ZcRxObject
{
public:
	...
	Zcad::ErrorStatus   setFilter   (Filter filter);
	Filter              filter      (void) const;
    static const ZcGiMaterialMap kNull;
...
class ZCGIMAT_IMPEXP ZcGiMapper: public ZcGiParameter
{
public:
	ZCRX_DECLARE_MEMBERS_READWRITE(ZcGiMapper, ZcGiImpMapper);
    ...
    static const ZcGiMapper kIdentity;
