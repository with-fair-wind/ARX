...
class ZCBASE_PORT ZcRxEventReactor: public ZcRxObject 
{
public:

    ZCRX_DECLARE_MEMBERS(ZcRxEventReactor);

    ZSOFT_DEPRECATED virtual void dwgFileOpened(ZcDbDatabase*, ZTCHAR * ) final {}
    virtual void dwgFileOpened(ZcDbDatabase*, const ZTCHAR * ) {}
    ...
    virtual void beginInsert(ZcDbDatabase* pTo, const ZTCHAR * pBlockName, ZcDbDatabase* pFrom) {}
    virtual void beginInsert(ZcDbDatabase* pTo, const ZcGeMatrix3d& xform, ZcDbDatabase* pFrom) {}
    virtual void otherInsert(ZcDbDatabase* pTo, ZcDbIdMapping& idMap, ZcDbDatabase* pFrom) {}
    ...
    virtual void beginWblock(ZcDbDatabase* pTo, ZcDbDatabase* pFrom, const ZcGePoint3d*& insertionPoint) {}
    virtual void beginWblock(ZcDbDatabase* pTo, ZcDbDatabase* pFrom, ZcDbObjectId blockId) {}
    virtual void beginWblock(ZcDbDatabase* pTo, ZcDbDatabase* pFrom) {}
    virtual void otherWblock(ZcDbDatabase* pTo, ZcDbIdMapping&, ZcDbDatabase* pFrom) {}
    ...
    virtual void beginAttach(ZcDbDatabase* pTo, const ZTCHAR *, ZcDbDatabase* pFrom) {}
    ...
    virtual void comandeered(ZcDbDatabase* pTo, ZcDbObjectId id, ZcDbDatabase* pFrom) {}
    virtual void beginRestore(ZcDbDatabase* pTo, const ZTCHAR *, ZcDbDatabase* pFrom) {}
...
class ZCBASE_PORT ZcRxEvent: public ZcRxObject 
{ 
public:
