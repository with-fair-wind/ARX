...
public:
    ...
    ZcDbObjectPointerBase(ZcDbObjectPointerBase&&);
    ZcDbObjectPointerBase& operator=(ZcDbObjectPointerBase&&);
...
private:
    ...
    ZcDbObjectPointerBase(const ZcDbObjectPointerBase & pObject) = delete;
    ZcDbObjectPointerBase& operator=(const ZcDbObjectPointerBase & pObject) = delete;
...
public:
    ...
    ZcDbObjectPointer(ZcDbObjectId   objId,
                      ZcDb::OpenMode mode = ZcDb::kForRead,
                      bool           openErased = false);
    ZcDbObjectPointer(ZcDbObjectPointer&&) = default;
    ZcDbObjectPointer& operator=(ZcDbObjectPointer&&) = default;
...
private:
    ...
    ZcDbObjectPointer(const ZcDbObjectPointer & pObject) = delete;
    ZcDbObjectPointer& operator=(const ZcDbObjectPointer & pObject) = delete;
};
...
public:
    ...
    ZcDbSymbolTablePointer(ZcDbObjectId objId, ZcDb::OpenMode mode = ZcDb::kForRead);
    ZcDbSymbolTablePointer(ZcDbDatabase * pDb, ZcDb::OpenMode mode = ZcDb::kForRead);

    ZcDbSymbolTablePointer(ZcDbSymbolTablePointer&&) = default;
    ZcDbSymbolTablePointer& operator=(ZcDbSymbolTablePointer&&) = default;
    ...
    Zcad::ErrorStatus open(ZcDbObjectId objId, ZcDb::OpenMode mode = ZcDb::kForRead);
    Zcad::ErrorStatus open(ZcDbDatabase* pDb, ZcDb::OpenMode mode = ZcDb::kForRead);

private:
    
    ZcDbSymbolTablePointer(const ZcDbSymbolTablePointer & pObject) = delete;
    ZcDbSymbolTablePointer& operator=(const ZcDbSymbolTablePointer & pObject) = delete;
...
public:
    ...
    ZcDbSymbolTableRecordPointer(ZcDbSymbolTableRecordPointer&&) = default;
    ZcDbSymbolTableRecordPointer& operator=(ZcDbSymbolTableRecordPointer&&) = default;
...
private:
    ...
    ZcDbSymbolTableRecordPointer(const ZcDbSymbolTableRecordPointer & pObject) = delete;
    ZcDbSymbolTableRecordPointer& operator=(const ZcDbSymbolTableRecordPointer & pObject) = delete;
...
template<class T_OBJECT> inline
ZcDbObjectPointerBase<T_OBJECT>::ZcDbObjectPointerBase(
    ZcDbObjectPointerBase&& other)
    : m_ptr(other.m_ptr)
    , m_status(other.m_status)
{
    other.m_ptr = nullptr;
    other.m_status = Zcad::eNullObjectPointer;
}

template<class T_OBJECT> inline ZcDbObjectPointerBase<T_OBJECT>&
ZcDbObjectPointerBase<T_OBJECT>::operator=(ZcDbObjectPointerBase&& other)
{
    close();
...
ZcDbObjectPointerBase<T_OBJECT>::close()
{
    ...
    assert(m_status == Zcad::eOk);
    Zcad::ErrorStatus closeStatus = closeInternal();
    ZSOFT_UNREFED_PARAM(closeStatus);
    assert(closeStatus == Zcad::eOk);
    return Zcad::eOk;
}
