...
class ZCUI_PORT CZcUiQuickSelectButton : public CZdUiBitmapButton {
    DECLARE_DYNAMIC(CZcUiQuickSelectButton)

public:
                CZcUiQuickSelectButton ();
virtual         ~CZcUiQuickSelectButton ();
