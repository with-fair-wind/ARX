...
ZCDBCORE2D_PORT    int           zcdbXdRoom (const zds_name ent, ZSoft::Int32 *result); 
ZCDBCORE2D_PORT    int           zcdbXdSize (const resbuf *rb, ZSoft::Int32 *result); 
ZCDBCORE2D_PORT    ZTCHAR *      zcdbXStrSave (ZTCHAR *pSource, ZTCHAR **pDest); 
ZCDBCORE2D_PORT    int           zcdbXStrCase (ZTCHAR *str, size_t strLen);
