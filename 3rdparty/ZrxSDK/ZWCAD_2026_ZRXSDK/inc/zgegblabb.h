...
typedef ZcGe::KnotParameterization KnotParameterization;

const ZcGe::KnotParameterization kChord = ZcGe::kChord;
const ZcGe::KnotParameterization kSqrtChord = ZcGe::kSqrtChord;
const ZcGe::KnotParameterization kUniform = ZcGe::kUniform;
const ZcGe::KnotParameterization kCustomParameterization = ZcGe::kCustomParameterization;
const ZcGe::KnotParameterization kNotDefinedKnotParam = ZcGe::kNotDefinedKnotParam;
