...
class ZCDBCORE2D_PORT ZcDbLeader: public  ZcDbCurve
{
public:
    ZcDbLeader();
    ~ZcDbLeader();
	...
	void            setHasArrowHead   (ZSoft::Boolean bEnable);		
	...
	void            setSplined        (ZSoft::Boolean bSplined);	
	...
	Zcad::ErrorStatus setAnnotationObjId(const ZcDbObjectId& annoId);	
    ...
    virtual void              erased            (const ZcDbObject*,
                                                 ZSoft::Boolean = ZSoft::kTrue) override;
    virtual void              goodbye           (const ZcDbObject*) override;
    virtual void              copied            (const ZcDbObject*,
                                                 const ZcDbObject*) override;

    virtual void              setDimVars        ();
    virtual Zcad::ErrorStatus setColorIndex     (ZSoft::UInt16,
                                 ZSoft::Boolean doSubents = ZSoft::kTrue) override;
protected:
