...
#ifndef __DBPLHLDR_H__
#define __DBPLHLDR_H__

#include "dbmain.h"

#include "../../inc/zdbplhldr.h"
...
#define AcDbPlaceHolder		ZcDbPlaceHolder
#endif //#ifndef AcDbPlaceHolder
