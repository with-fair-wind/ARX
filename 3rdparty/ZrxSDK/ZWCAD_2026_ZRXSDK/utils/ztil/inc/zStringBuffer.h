...
/// <summary>
/// The <c>StringBuffer</c> class is ZTIL's class for avoiding string handling.
...
public:
    ...
    /// <summary>
    /// This returns <c>CharacterType</c> under which ZTIL was built.
    /// </summary>
    ///
	/// <returns>
...
public:
    ...
    /// <summary> Cast operator to convert to a <c>Ztil::char_t</c> for use as the
    /// default string type on the platform ZTIL is compiled for. </summary>
    /// <returns> This returns a <c>const char_t*</c> pointer for use as a string.</returns>
