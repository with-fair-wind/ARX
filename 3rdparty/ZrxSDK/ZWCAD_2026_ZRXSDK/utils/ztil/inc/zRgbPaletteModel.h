...
#endif
#ifndef ZRGBPALETTEMODEL_H
#define ZRGBPALETTEMODEL_H
#if  __GNUC__ >= 4
...
/// </summary>
///
class DllImpExp RgbPaletteModel : public RgbModel
{
public:
    /// <summary>
    ...
    /// <summary> Palette initializing constructor.</summary>
    /// <param name='nEntries'> The number of entries that in the palette.</param>
    ...
    ///  if an invalid palette index is specified. <see cref="ZTILException"/>.
    /// </exception>
    ///
    ...
    /// </returns>
    ///
    Ztil::UInt8 nearestColorIndex (Ztil::RgbColor color ) const;
...
/// <summary>
/// A specialization of the <c>ZTILException</c> class for use by <c>RgbPaletteModel</c>
/// </summary>
///
class DllImpExp RgbPaletteModelException : public ZTILException
{
public:
    /// <summary>
