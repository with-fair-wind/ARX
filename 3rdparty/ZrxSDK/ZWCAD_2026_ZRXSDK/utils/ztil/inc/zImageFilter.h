...
#include "zRowProviderInterface.h"
#endif
#ifndef ZSIZE_H
#include "zSize.h"
#endif
...
/// </summary>
class DllImpExp ImageFilter : public RowProviderInterface
{
public:
    ...
    /// allocate a buffer that conforms to the ZTIL packing.
    /// </summary>
    ///
	/// <returns>
...
/// </remarks>
///
class DllImpExp ImageFilterException : public ZTILException 
{
public:
