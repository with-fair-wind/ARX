...
#ifndef ZJFIFFORMATCODEC_H
#define ZJFIFFORMATCODEC_H
#if  __GNUC__ >= 4
...
extern "C"
{
    ...
    /// </returns>
    ///
    ZTIL_GCC_DEFAULT const Ztil::FormatCodecApiVersionInterface* ZTIL_EXPORT jfifApiVersion ();
}
/// <summary>
...
/// </summary>
///
class DllImpExp JfifFormatCodec : public Ztil::ImageFormatCodec, public Ztil::ImageFormatCodecStreamingInterface
{
public:
    /// <summary> 
...
public:
    ...
    virtual bool isSupportedProperty (
        ...
        Ztil::StringBuffer* pCustomPropertyName = NULL ) const;
    ...
    /// </returns>
    ///
    virtual bool getJfifPropertyName ( JfifPropertyIdentifier id, Ztil::StringBuffer& sbName  ) const;
    ...
    virtual Ztil::ImageFormatCodec::FormatDecodability isDecodableFile (
        const Ztil::FileSpecifier& fileSpecifier, Ztil::FindFileInterface * ff = NULL ) const;
