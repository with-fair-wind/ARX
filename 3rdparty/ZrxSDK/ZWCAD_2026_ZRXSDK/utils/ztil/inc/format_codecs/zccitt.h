...
/// <summary> forward declaration of the Ztil::DataStreamInterface. </summary>
...
public:
    ...
    virtual void decodeByRow(Ztil::DataStreamInterface* pStream ) = 0;
