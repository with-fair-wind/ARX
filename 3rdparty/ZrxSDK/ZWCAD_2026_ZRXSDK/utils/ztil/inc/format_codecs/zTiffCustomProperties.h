...
#include "../codec_properties/zFormatCodecPropertyInterface.h"
#endif
#ifndef ZFORMATCODECPROPERTYSETITERATOR_H
#include "../codec_properties/zFormatCodecPropertySetIterator.h"
#endif
#ifndef ZFORMATCODECSTRINGPROPERTY_H
#include "../codec_properties/zFormatCodecStringProperty.h"
#endif
#ifndef ZFORMATCODECDENSITY_H
#include "../codec_properties/zFormatCodecDensity.h"
#endif
#ifndef ZFORMATCODECASSOCIATION_H
#include "../codec_properties/zFormatCodecAssociation.h"
#endif
#ifndef ZSTRINGBUFFER_H
#include "../zStringBuffer.h"
#endif
#ifndef ZZFORMATCODECEXCLUSIVEPROPERTYSETINTERFACE_H
#include "../codec_properties/zFormatCodecExclusivePropertySetInterface.h"
#endif
#ifndef ZFORMATCODECTRANSPARENCY_H
#include "../codec_properties/zFormatCodecTransparency.h"
#endif
#ifndef ZTIFFFORMATCODEC_H
#include "zTiffFormatCodec.h"
#endif

#ifndef ZTIFFCUSTOMPROPERTIES_H
#define ZTIFFCUSTOMPROPERTIES_H
#if  __GNUC__ >= 4
...
/// <summary>
/// This class serves as the base class for all non-ZTIL TIFF Format codec
/// specific properties.
/// </summary>
///
class DllImpExp TiffProperty 
{
public:
    /// <summary>
...
/// </summary>
///
class DllImpExp TiffCompressionType : public Ztil::FormatCodecPropertyInterface, public TiffProperty
{
public:
    /// <summary>
...
class DllImpExp TiffCompression : public Ztil::FormatCodecExclusivePropertySetInterface, public TiffProperty
{
public:
    /// <summary>
...
/// </summary>
///
class DllImpExp TiffPhotometricInterpretation : public Ztil::FormatCodecExclusivePropertySetInterface, public TiffProperty
{
public:
    /// <summary>
...
/// </summary>
///
class DllImpExp TiffFillOrder : public Ztil::FormatCodecExclusivePropertySetInterface, public TiffProperty
{
public:
...
/// </summary>
class DllImpExp TiffGrayResponseCurve : public Ztil::FormatCodecPropertyInterface, public TiffProperty
{
public:
    /// <summary>
    /// The constructor.
...
/// </summary>
///
class DllImpExp TiffText : public Ztil::FormatCodecStringProperty, public TiffProperty
{
public:
    /// <summary>
    /// The constructor.
    ...
    /// </param>
    ///
    TiffText (TiffFormatCodec::TiffId tiffId, Ztil::StringBuffer* psbText);
    ...
    /// </returns>
    ///
    bool setValue (const Ztil::StringBuffer& sbValue);
...
/// </summary>
///
class DllImpExp TiffPrivateTag : public Ztil::FormatCodecPropertyInterface, public TiffProperty
{
public:
    /// <summary>
...
/// </remarks>
///
class DllImpExp TiffSampleRange : public Ztil::FormatCodecInclusivePropertySetInterface, public TiffProperty
{
public:
...
/// </summary>
///
class DllImpExp TiffPageInformation : public Ztil::FormatCodecInclusivePropertySetInterface, public TiffProperty
{
public:
    ...
    /// </param>
    ///
    TiffPageInformation (Ztil::StringBuffer* pDoc, Ztil::StringBuffer* pPage,
    ...
    /// </returns>
    ///
    virtual bool getDocumentName ( Ztil::StringBuffer& sbName ) const;
    ...
    /// </returns>
    ///
    virtual bool getPageName ( Ztil::StringBuffer& sbName ) const;
