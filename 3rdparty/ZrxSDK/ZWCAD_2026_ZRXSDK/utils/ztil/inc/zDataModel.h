...
{
/// <summary>
/// This is the base class for all data models in ZTIL.
...
/// </remarks>
///
class DllImpExp DataModel : public DataModelAttributes
{
public:
    /// <summary>
    /// The enum declares the allowable tile sizes within ZTIL.
    /// </summary>
    ///
    /// <remarks>
    /// Although each dimension of the tiles are declared, tiles in 
    /// ZTIL are always square.
    /// </remarks>
    ///
    enum TileSize {
        /// <summary>
        ...
        k1024x1024,
        /// <summary>
        /// This enum is a special purpose enum that allows ZTIL to choose an
        /// appropriate tile size during construction of an Image.
        /// </summary>
        ///
        kUnspecified,
        /// <summary>
        /// This enum is a special purpose enum that tells ZTIL to use the
    ...
    /// by ZTIL. ZTIL expects all row sizes to be 8 byte aligned.
    /// </remarks>
    ///
    ...
    /// 
    /// <param name="size">
    /// An enum constant describing the size of an ZTIL tile.
    /// </param>
    ///
    /// <param name="nRows">
...
public:
	...
	///
    /// <remarks>
    /// The bit packing size in ZTIL is 8. This means that a 4 bit per pixel image
    ...
    /// which of the ZTIL defined color type DataModel derived types this
    /// data model is.
    /// </summary>
    ///
    /// <returns>
    ...
    /// ZTIL exposes this enum to help in identifying the DataModel derivatives that
    /// ZTIL defines. The current ZTIL defined datamodels are based on RgbModel 
...
protected:
    ...
    /// <summary>
    ///  The number of bits used in the pixel always equal to or less than those declared in <c>mPackedBits</c>.
    /// </summary>
    ///
    int mnDataBits;
