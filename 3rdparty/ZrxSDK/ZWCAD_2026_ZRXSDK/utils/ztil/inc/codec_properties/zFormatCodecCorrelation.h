...
#define ZFORMATCODECCORRELATION_H
#if  __GNUC__ >= 4
...
///system. </summary>
class DllImpExp FormatCodecCorrelation : public FormatCodecPropertyInterface
{
public:
    enum Units {
...
public:
    ...
    virtual void getCoordinateSystemDescription (Ztil::StringBuffer& sbDescription) const;
...
class DllImpExp FormatCodecCorrelationSet : public FormatCodecInclusivePropertySetInterface
{
public:
    /// <summary>Empty constructor.</summary>
