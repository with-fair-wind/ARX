...
{
/// <summary>
/// This ZTIL property encodes density (pixels per unit of measure) of the image frame.
/// </summary>
///
class DllImpExp FormatCodecDensity : public FormatCodecPropertyInterface
{
public:
    /// <summary>
