...
#define ZTRANSFORMS_H
#if  __GNUC__ >= 4
#pragma GCC visibility push(default)
#endif

#ifndef PIXELCOPIER_H
namespace Ztil { class PixelCopier; }
#endif
namespace Ztil {
...
/// </returns>
///
RowProviderInterface* ZTIL_EXPORT newScaleFilter ( RowProviderInterface* pInput,
    const Size& output );
...
/// </param>
/// 
/// <param name="szOutput">A constant reference to a <c>Size</c> instance that dictates the
/// desired output size (in pixels). The difference between the input and output sizes
/// determines the needed scale factor.
/// </param>
///
...
/// </returns>
///
RowProviderInterface* ZTIL_EXPORT newScaleFilter ( const Image* pImage,
                                                  const Size& szOutput );
...
///
RowProviderInterface* ZTIL_EXPORT newScaleFilter ( const Image* pImage,
                const Size& size, const Offset& offset, const Size& szOutput );


/// <summary>
/// This structure enclose the definition of an enum that declares the differing methods
/// of interpolation during resampling that are available with the ZTIL resample filters.
/// </summary>
///
struct Resample {

    /// <summary>
    /// This enum declares the resampling methods available in ZTIL's resample filter.
    ...
    enum FilterTypes { 
        ...
        kMitchell, 
        /// <summary>
        /// This method is for binary images. It is a modified Bell resampling that simply
        /// scales the curve of the bell higher giving an output intensity promotion.
        /// </summary>
        ///
        kBellBinary
    };
...
/// </summary>
/// 
/// <param name="pImage">A pointer to a <c>Image</c> derived object that
/// will provide the source data to be resampled.
/// </param>
/// 
/// <param name="size">The size of the sub-region of the image to be read which may
/// be up to the full size of the image. 
...
/// </returns>
///
RowProviderInterface* ZTIL_EXPORT newResampleFilter(const Image* pImage
    , const Size& size, const Offset& offset, Resample::FilterTypes filterMethod
    , bool bAdaptive, bool bProcessAlpha, const Size& szOutput);

/// <summary>
/// This structure enclose the definition of an enum that declares the differing methods
/// of shearing that are available with the ZTIL shear filters.
/// </summary>
///
struct Shear {
    /// <summary>
    /// This enum declares the methods available in ZTIL's shear filter.
    /// </summary>
    ///
    enum Quality {
        /// <summary>
...
/// </returns>
///
RowProviderInterface* ZTIL_EXPORT newResampleFilter ( RowProviderInterface* pInput
...
/// </returns>
///
RowProviderInterface* ZTIL_EXPORT newXShearFilter ( RowProviderInterface* pInput,
...
/// </returns>
///
RowProviderInterface* ZTIL_EXPORT newYShearFilter ( RowProviderInterface* pInput,
...
/// </returns>
///
RowProviderInterface* ZTIL_EXPORT newRotateFilter ( RowProviderInterface* pInput,
...
public:
    ...
    /// <returns>
    /// A pointer to a <c>RowProviderInterface</c> derived object that
    /// will provide the transformed data. The viewed rectangle (in output coords) is defined to be from 0,0 to output size.
    /// </returns>
    ///
    ...
    bool getInputandOrientation (Offset& origin, Size& size,
        Ztil::Orientation& orientation) const;
...
/// </returns>
///
bool ZTIL_EXPORT bufferedImageBottomUpPaste( Image* pImage,
