...
/// together with a <c>FileReadDescriptor</c> to read an image into ZTIL or
/// a <c>FileWriteDescriptor</c> to write and image from ZTIL to an 
/// external source.
/// </summary>
///
/// <remarks>
...
/// </remarks>
///
class DllImpExp DataStreamInterface 
{
public:
    /// <summary>
...
/// </summary>
///
class DllImpExp SeekableDataStreamInterface : public Ztil::DataStreamInterface
{
public:
